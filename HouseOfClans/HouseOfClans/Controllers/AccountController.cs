...
namespace HouseOfClans.Controllers
{
    ...
    public class AccountController : Controller
    {
		...
		/// <summary>
		/// If the application roles don't exist then we create them.
		/// Currently we are having two roles: Admin, and Normal. Might considere creating an Enum
		/// ref: http://stackoverflow.com/questions/26174576/initializing-rolemanager-in-asp-net-identity-with-custom-roles
		/// </summary>
		private void CheckAspRoles()
		{
			...
			//TODO //vv add a method/way/page where we would change the role if needed.
			//vv UserManager.RemoveFromRole, then UserManager.AddToRole is the way I don't think there is an Update.
		}
